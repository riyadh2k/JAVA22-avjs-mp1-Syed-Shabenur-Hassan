...
})({"gyfi6":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "fcde6341393b2f70";
"use strict";
...
},{}],"auS6b":[function(require,module,exports) {
...
const game = ()=>{
        ...
        playerOptions.forEach((option)=>{
            option.addEventListener("click", function() {
                ...
                if (computerScore === 1) {
                    ...
                    (0, _main.updateHighscore)((0, _main.userName), lastScore).then(()=>{
                        (0, _main.displayHighscore)();
                        lastScore = 0;
                        location.reload();
                    });
                }
    ...
    const winner = (player, computer)=>{
        ...
        if (player === computer) result.textContent = "Tie";
        else if (player == "rock") {
            if (computer == "paper") {
...
game(); //export{playerScore};

},{"./main":"ihxUU"}]},["gyfi6","auS6b"], "auS6b", "parcelRequirebd0d")

//# sourceMappingURL=index.393b2f70.js.map
