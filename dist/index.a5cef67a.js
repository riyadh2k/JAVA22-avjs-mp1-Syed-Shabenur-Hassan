...
})({"gPxSp":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a8e42b52a5cef67a";
"use strict";
...
async function updateHighscore(name, score) {
    ...
    if (existingNameIndex !== -1) // If the name already exists, add the new score to the existing score for that entry
    highscoreArray[existingNameIndex][1].score += score;
    else // If the name does not exist, add a new entry to the highscore array
    highscoreArray.push([
        "",
        {
            name: name,
    ...
    const updates = {};
    for(let i = 0; i < highscoreArray.length; i++)updates[i] = highscoreArray[i][1];
...
},{}]},["gPxSp","ihxUU"], "ihxUU", "parcelRequirebd0d")

//# sourceMappingURL=index.a5cef67a.js.map
